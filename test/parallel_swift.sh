...
echo 'dataset write'
srun -n 2 ./HDF5_dataset_write_parallel liu_xss3.h5 mygroup mydset 3 10 20 30 # run as ./HDF5_objects_create_parallel filename groupname datasetname ndims dims0 dims1

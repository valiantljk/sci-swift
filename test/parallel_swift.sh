...
srun -n 2 ./HDF5_dataset_write_parallel cutter2.h5 liu_grp liu_dset 3 10 20 30 # run as ./HDF5_objects_create_parallel filename groupname datasetname ndims dims0 dims1

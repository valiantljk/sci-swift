...
'''
def swift_object_create(options=None, container=container, sciobj_name = sciobj_name, sciobj_source=None):
	try:
		...
		print ("swift object create initialize failed")
		print (e)
...
def sci_swift_object(sciobj_name, sciobj_source):
	...
	return objs
def swift_object_open(options=None, container=container, sciobj_name = sciobj_name):
